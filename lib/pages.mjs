...
function homePage({ config, packages }) {
  const content = `<section class="hero">
    ...
    <div class="hero-inner container-wide">
      ...
      <aside class="partner-card"><p>Connectivity partner</p><div class="partner-lockup"><img src="/assets/vodacom-business.svg" alt="Vodacom Business" width="190" height="58"><span class="partner-divider"></span><img class="group-logo" src="/assets/backyardconnect-logo.svg" alt="Backyard Connect" width="190" height="50"></div></aside>
    </div>
  </section>
